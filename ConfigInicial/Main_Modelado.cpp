...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Garcia Hernandez Jesus Francisco - Previo 4. Modelado geometrico", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Torso
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(0.8f, 1.2f, 0.4f));
		...
		// Pierna derecha
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(0.4f, 1.3f, 0.4f));
		model = glm::translate(model, glm::vec3(0.55f, -1.0f, 0.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
